...
local translation = {
  ...
  UIText = {
    ...
    Contextual = {
      ...
      info_contextual = "Contextual Frame Generation is a new feature that smoothly toggles frame generation ON/OFF based on the game's events. The feature allows you to prioritize image quality and get rid of frame generation artefacts for selected contexts, like city sightseeing, slow-paced scenes or cinematics.",
