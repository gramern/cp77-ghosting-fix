...
local Preset = {
    ...
    MaskingInVehiclesGlobal = {
	  ...
	  PresetInfo = {
        ...
        -- without supporting transitions: display = "Less masking for 4:3 (60+ FPS with FG ON)",
        display = UITranslation.Presets.MyAuthorName.My_Special_Preset.name or "Less masking for 4:3 (60+ FPS with FG ON)",
