...
local Preset = {
  ...
  PresetInfo = {
    ...
    display = UITranslation.Presets.Gramern.HDRTest1.name or "RenoDX HDR Test 1",
    ...
    description = UITranslation.Presets.Gramern.HDRTest1.description or "A HDR preset exlusively for RenoDX's HDR.\nFor the in-game HDR PQ10 use the default preset.",
    author = nil
  }
}
