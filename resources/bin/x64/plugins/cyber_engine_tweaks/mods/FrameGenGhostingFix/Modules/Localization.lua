...
local UIText = {
  ...
  Contextual = {
    ...
    tooltip_context_sightseeing = "Sightseeing",
    tooltip_context_slow_paced = "Slow Paced and Cinematics",
    tooltip_context_fast_paced = "Fast Paced",
    tooltip_context_my_own = "My Own",
  },
  Settings = {
