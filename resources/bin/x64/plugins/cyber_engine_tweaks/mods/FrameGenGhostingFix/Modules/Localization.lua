local Localization = {
  ...
  UIText = {
    ...
    Options = {
      ...
      enableFG = "Toggle Frame Generation",
      tooltipFG = "Turn on/off Frame Generation, so you don't have to do it from the game menu.",
      gameSettingsFG = "[ ! ] Please make sure frame generation is always enabled in game menu for this to function correctly.",
      gameNotReadyWarning = "You need to start or unpause the game to change this function",
      Benchmark = {
  ...
  LogText = {
    ...
    tracker_missing = "Can't find the 'Globals' module. The mod won't work...",
