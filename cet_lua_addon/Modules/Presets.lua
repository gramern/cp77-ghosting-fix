...
function Presets.ApplyPreset()
  ...
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraTPPCarSlowEvent', function(self)
  ...
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraTPPCarCrawlEvent', function(self)
  ...
  --TPPFar Car
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraTPPFarCarEvent', function(self)
  ...
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraTPPFarCarFasterEvent', function(self)
  ...
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraTPPFarCarSlowEvent', function(self)
  ...
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraTPPFarCarCrawlEvent', function(self)
  ...
  --FPP Car
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraFPPCarEvent', function(self)
  ...
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraFPPCarFasterEvent', function(self)
  ...
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraFPPCarSlowEvent', function(self)
  ...
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraFPPCarCrawlEvent', function(self)
  ...
  --TPP Bike
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraTPPBikeEvent', function(self)
  ...
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraTPPBikeFasterEvent', function(self)
  ...
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraTPPBikeSlowEvent', function(self)
  ...
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraTPPBikeCrawlEvent', function(self)
  ...
  --TPPFar Bike
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraTPPFarBikeEvent', function(self)
  ...
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraTPPFarBikeFasterEvent', function(self)
    self:OnFrameGenGhostingFixVehicleSetTransition(Vector2.new({X = Vectors.VehMasks.HorizontalEdgeDown.Margin.left, Y = Vectors.VehMasks.HorizontalEdgeDown.Margin.top}), Vector2.new({X = Vectors.VehMasks.HorizontalEdgeDown.Size.x, Y = Vectors.VehMasks.HorizontalEdgeDown.Size.y}), Vector2.new({X = Vectors.VehMasks.Mask2.ScreenSpace.x, Y = Vectors.VehMasks.Mask2.ScreenSpace.y}), Vector2.new({X = Vectors.VehMasks.Mask2.Size.x, Y = Vectors.VehMasks.Mask2.Size.y}), Vectors.VehMasks.Mask2.rotation, Vector2.new({X = Vectors.VehMasks.Mask1.ScreenSpace.x, Y = Vectors.VehMasks.Mask1.ScreenSpace.y}), Vector2.new({X = Vectors.VehMasks.Mask1.Size.x, Y = Vectors.VehMasks.Mask1.Size.y}), Vectors.VehMasks.Mask1.rotation, Vector2.new({X = Vectors.VehMasks.AnchorPoint.x, Y = Vectors.VehMasks.AnchorPoint.y}), Config.TPPFarBike.faster[1], Config.TPPFarBike.faster[2], Config.TPPFarBike.faster[3], Vectors.VehMasks.HorizontalEdgeDown.visible, Vectors.VehMasks.Mask2.visible, Vectors.VehMasks.Mask1.visible)
  end)
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraTPPFarBikeSlowEvent', function(self)
    self:OnFrameGenGhostingFixVehicleSetTransition(Vector2.new({X = Vectors.VehMasks.HorizontalEdgeDown.Margin.left, Y = Vectors.VehMasks.HorizontalEdgeDown.Margin.top}), Vector2.new({X = Vectors.VehMasks.HorizontalEdgeDown.Size.x, Y = Vectors.VehMasks.HorizontalEdgeDown.Size.y}), Vector2.new({X = Vectors.VehMasks.Mask2.ScreenSpace.x, Y = Vectors.VehMasks.Mask2.ScreenSpace.y}), Vector2.new({X = Vectors.VehMasks.Mask2.Size.x, Y = Vectors.VehMasks.Mask2.Size.y}), Vectors.VehMasks.Mask2.rotation, Vector2.new({X = Vectors.VehMasks.Mask1.ScreenSpace.x, Y = Vectors.VehMasks.Mask1.ScreenSpace.y}), Vector2.new({X = Vectors.VehMasks.Mask1.Size.x, Y = Vectors.VehMasks.Mask1.Size.y}), Vectors.VehMasks.Mask1.rotation, Vector2.new({X = Vectors.VehMasks.AnchorPoint.x, Y = Vectors.VehMasks.AnchorPoint.y}), Config.TPPFarBike.slow[1], Config.TPPFarBike.slow[2], Config.TPPFarBike.slow[3], Vectors.VehMasks.HorizontalEdgeDown.visible, Vectors.VehMasks.Mask2.visible, Vectors.VehMasks.Mask1.visible)
  end)
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraTPPFarBikeCrawlEvent', function(self)
    self:OnFrameGenGhostingFixVehicleSetTransition(Vector2.new({X = Vectors.VehMasks.HorizontalEdgeDown.Margin.left, Y = Vectors.VehMasks.HorizontalEdgeDown.Margin.top}), Vector2.new({X = Vectors.VehMasks.HorizontalEdgeDown.Size.x, Y = Vectors.VehMasks.HorizontalEdgeDown.Size.y}), Vector2.new({X = Vectors.VehMasks.Mask2.ScreenSpace.x, Y = Vectors.VehMasks.Mask2.ScreenSpace.y}), Vector2.new({X = Vectors.VehMasks.Mask2.Size.x, Y = Vectors.VehMasks.Mask2.Size.y}), Vectors.VehMasks.Mask2.rotation, Vector2.new({X = Vectors.VehMasks.Mask1.ScreenSpace.x, Y = Vectors.VehMasks.Mask1.ScreenSpace.y}), Vector2.new({X = Vectors.VehMasks.Mask1.Size.x, Y = Vectors.VehMasks.Mask1.Size.y}), Vectors.VehMasks.Mask1.rotation, Vector2.new({X = Vectors.VehMasks.AnchorPoint.x, Y = Vectors.VehMasks.AnchorPoint.y}), Config.TPPFarBike.crawl[1], Config.TPPFarBike.crawl[2], Config.TPPFarBike.crawl[3], Vectors.VehMasks.HorizontalEdgeDown.visible, Vectors.VehMasks.Mask2.visible, Vectors.VehMasks.Mask1.visible)
  end)

  --FPP Bike
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraFPPBikeEvent', function(self)
  ...
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraFPPBikeFasterEvent', function(self)
  ...
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraFPPBikeSlowEvent', function(self)
  ...
  Override('gameuiCrosshairContainerController', 'OnFrameGenGhostingFixCameraFPPBikeCrawlEvent', function(self)
