...
local Presets = {
    ...
    TPPFarCar = {
        full = {7680.0, 800.0, 2000.0, 1150.0, 1800.0, 700.0, 0.0, 0.03, 0.03, 0.03, 0.03, 0.0, 0.0},
        slow = {7680.0, 950.0, 2600.0, 800.0, 1800.0, 800.0, 0.0, 0.02, 0.02, 0.02, 0.02, 0.0, 0.0},
    ...
    Default43 = {
        ...
        TPPBike = {
            full = {7680.0, 1200.0, 3400.0, 1200.0, 1400.0, 1400.0, 0.03, 0.04, 0.03, 0.03, 0.03, 0.0, 0.0},
            faster = {7680.0, 950.0, 3200.0, 1050.0, 1400.0, 1400.0, 0.025, 0.025, 0.025, 0.025, 0.02, 0.0, 0.0},
            slow = {7680.0, 950.0, 2400.0, 700.0, 1800.0, 800.0, 0.02, 0.02, 0.02, 0.02, 0.01, 0.0, 0.0},
            crawl = {7680.0, 950.0, 2400.0, 700.0, 1800.0, 800.0, 0.01, 0.01, 0.01, 0.01, 0.01, 0.0, 0.0}
        },
        TPPFarBike = {
            full = {7680.0, 950.0, 2000.0, 1050.0, 1800.0, 800.0, 0.0, 0.03, 0.03, 0.03, 0.03, 0.0, 0.0},
            slow = {7680.0, 950.0, 2000.0, 900.0, 1800.0, 800.0, 0.0, 0.02, 0.02, 0.02, 0.02, 0.0, 0.0},
...
function Presets.LoadPreset()
    -- print(Presets.selectedPresetPosition,Presets.presetsFile[Presets.selectedPresetPosition])
    -- print(Presets.selectedPresetPosition,Presets.presetsList[Presets.selectedPresetPosition])
    -- print(Presets.selectedPresetPosition,Presets.presetsDesc[Presets.selectedPresetPosition])
    -- print(Presets.selectedPresetPosition,Presets.presetsAuth[Presets.selectedPresetPosition])
