...
local UIText = {
    General = {
        ...
        title_fps90 = "Frame Generation 90+ FPS Recommended Settings:",
        title_fps100 = "Frame Generation 100+ FPS Recommended Settings:",
        title_fps120 = "Frame Generation 120+ FPS Recommended Settings:",
	...
	Diagnostics = {
        tabname = "Diagnostics",
        title = "POTENTIAL CONFLICTS WITH OTHER MODS DETECTED",
        textfield_1 = "To resolve conflicts with these mods:",
        textfield_2 = "and ensure Ghosting 'Fix' will work as expected,\nplease visit the mod's Nexus page for compatibility\ntweaks and instructions."
    },
    VehiclesFPP = {
        tabname = "Vehicles FPP",
        SideMirror = {
            name = "Enable left-side mirror anti-ghosting FPP mask",
        ...
        ELG = {
            name = "Enable 'Even Less Ghosting' anti-ghosting FPP masks",
    ...
    OnFoot = {
        ...
        Vignette = {
            ...
            textfield_1 = "Sliders below let you customize the vignette's dimensions to\ncover ghosting on your screen edges. For framerates lower\nthan recommended, these settings come at a cost of perceived\nsmoothness in outermost areas of your field of view.",
            setting_1 = "Vignette's horizontal position:",
            setting_2 = "Vignette's vertical position:",
            setting_3 = "Vignette's width:",
            setting_4 = "Vignette's height:"
        },
        VignettePermament = {
